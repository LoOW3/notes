...
Una colección que se caracteriza por utilizar **clave : valor**

Map no puede tener claves múltiples

Acceso rápido a los valores a través de las claves
...
**put(clave,valor)**: agregar key-value a la collection
**get(clave)**: Devuelve valor asociado a la clave
**containsKey(clave)**: Verifica si el Map contiene la clave especificada
**containsValue(value)**: Verifica si el Map contiene el valor especificado
**remove(clave)**: Elimina el registro asociado a la clave
**keySet()**: Devuelve todas las claves del Map
**values()**: Devuelve una colección de todos los valores que contiene el Map


## HashMap

Práctica de métodos Map con HashMap
...
public class PruebaHashMap {
    ...
    public static void main(String[] args) {
        ...
        mapaEmpleados.put(1, "Ignacio");
        mapaEmpleados.put(2, "Exequiel");
        mapaEmpleados.put(3, "Diaz");
        mapaEmpleados.put(4, "Nanni");
        mapaEmpleados.put(5, "Lupe");
        
        if(mapaEmpleados.containsKey(1)){
            System.out.println("si tiene la key" + 1);
        }
        if(mapaEmpleados.containsValue("Lupe")){
            System.out.println("si tiene la key" + 1);
        ...
        String nombre = mapaEmpleados.get(2);
